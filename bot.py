...
class Client(discord.Client):
    ...
    WORD_FILTER = ["Fuck", "Rishan","Nigger","Nigga",
                   ...
                   "vape","vaping","vape","hookah","shisha","cigars","cigar","cigarette","cig",
                   "asshole","rape","whore","hoe","cb","kontol","babi","anjing","asu","babi","tolol","goblok","sampah","bangsat","bajingan","memek","jembut","tai kucing","tai ayam","tai kambing","tai sapi",
